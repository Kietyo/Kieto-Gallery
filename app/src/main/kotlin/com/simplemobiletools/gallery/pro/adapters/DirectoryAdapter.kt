...
class DirectoryAdapter(
    activity: BaseSimpleActivity, var dirs: MutableList<Directory>, val listener: DirectoryOperationsListener?, recyclerView: MyRecyclerView,
    ...
    fun updateDirs(newDirs: MutableList<Directory>) {
        val directories = newDirs.toMutableList()
